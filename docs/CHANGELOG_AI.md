...
- Documente un tarif à partir de 19 € HT/mois, modulable selon les fonctions activées, ainsi qu'un essai de 14 jours sans carte bancaire.
- Intègre trois médias officiels, une notation ToolTrim sourcée et des réserves sur le tarif final et la portabilité après résiliation.
- Maintient le site officiel et la page tarifaire en `nofollow`, avec un test de non-régression dédié.
...
- Couvertures des articles sans miniature restaurées depuis l'image éditoriale de leur outil principal ; fallback logo limité aux sources locales.
...
## 2026-09-26 : Leadpages, révision affiliée FR/EN

- Lien partenaire exact vérifié dans le navigateur. Nouvelle gamme Grow/Optimize/Scale distinguée de HTML Pub. Source https://leadpages.com/pricing : EUR localisés 115/229/399 mensuels, équivalents annuels affichés 91,67/183,33/319,17. Aucune conversion maison, taxes inconnues. Essai 7 jours avec carte ; FAQ contradictoire sur fin d’essai, donc conditions de paiement à vérifier, aucune promesse d’absence de prélèvement.
