...
4. quels prix ou plans restent a verifier.
...
- Le rapport affiche un bloc dedie quand des prix, plans ou devises restent incertains.
- Les outils concernes sont visibles avec leur statut : prix catalogue, plan a verifier, devise a verifier.
...
5. En preprod, terminer un diagnostic avec :
   - au moins un outil payant en USD ;
   - un outil gratuit ;
   - un plan incertain ;
   - un outil ajoute manuellement avec devise.
