...
export const STACKS: StackGuide[] = [
  ...
  },
  {
    ...
    title: "Quel agrégateur IA visuel pour remplacer 4 abonnements créatifs ?",
    titleEn: "Which all-in-one visual AI to replace 4 creative subscriptions?",
    subtitle: "Pour designer, DA freelance ou créatif qui empile Midjourney + Runway + Magnific + un upscaler — alors qu'une plateforme agrégatrice couvre 80% du besoin.",
    ...
    monthlyBudget: 35,
    savings: 70,
    risk: "Payer 4 plateformes IA visuelles séparées qui se chevauchent à 70% sur image, vidéo et upscale.",
    riskEn: "Paying for 4 separate visual AI platforms that overlap 70% on image, video, and upscale.",
    bestFor: "Moodboards, illustrations marketing, concept art, miniatures, vidéos courtes IA.",
    bestForEn: "Moodboards, marketing illustrations, concept art, thumbnails, short AI videos.",
    avoidIf: "Tu produis du print pro avec contraintes de droits commerciaux d'entreprise stricts.",
  ...
  },
  {
    ...
    title: "Quel constructeur no-code IA pour livrer une app sans Bubble + Webflow + Zapier ?",
    titleEn: "Which AI no-code builder to ship an app without Bubble + Webflow + Zapier?",
    subtitle: "Pour solo, indie hacker ou consultant qui veut livrer un MVP, un site et une logique métier sans empiler 4 outils no-code.",
    ...
    monthlyBudget: 25,
    savings: 80,
    risk: "Payer Bubble + Webflow + Zapier + Airtable alors qu'un seul builder IA couvre frontend, backend et déploiement.",
    riskEn: "Paying for Bubble + Webflow + Zapier + Airtable when one AI builder covers frontend, backend, and deployment.",
    bestFor: "MVP, sites client, prototypes interactifs, dashboards internes, micro-SaaS.",
    bestForEn: "MVPs, client sites, interactive prototypes, internal dashboards, micro-SaaS.",
    avoidIf: "Tu construis un produit avec contraintes de scalabilité, sécurité ou conformité avancées.",
  ...
  },
  {
    ...
    title: "Quelle stack IA personnelle pour penser, écrire et retrouver l'info ?",
    titleEn: "Which personal AI stack to think, write, and retrieve info?",
    subtitle: "Pour consultant, créateur ou knowledge worker qui veut un cerveau augmenté sans empiler ChatGPT + Notion AI + Otter + Mem + Raycast Pro en parallèle.",
    ...
    monthlyBudget: 30,
    savings: 50,
    risk: "Payer 4 IA personnelles qui font toutes du résumé, du chat et de la recherche dans tes notes.",
    riskEn: "Paying for 4 personal AIs that all do summarization, chat, and search in your notes.",
    bestFor: "Notes de réunion, second cerveau, recherche dans tes docs, rédaction quotidienne.",
    bestForEn: "Meeting notes, second brain, searching your docs, daily writing.",
    avoidIf: "Tu es à l'aise avec un seul outil et que ton workflow tient déjà dans Notion ou Obsidian.",
  ...
  },
  {
    ...
    title: "Quelle plateforme analytics produit pour remplacer Mixpanel + Hotjar + GA ?",
    titleEn: "Which product analytics platform to replace Mixpanel + Hotjar + GA?",
    subtitle: "Pour PM, founder ou growth qui empile 3 outils analytics alors qu'une seule plateforme couvre events, sessions et funnels.",
    ...
    monthlyBudget: 0,
    savings: 95,
    risk: "Payer Mixpanel + Hotjar + LogRocket + GA Premium alors qu'une plateforme open-source couvre 90% du besoin.",
    riskEn: "Paying for Mixpanel + Hotjar + LogRocket + GA Premium when one open-source platform covers 90% of the need.",
    bestFor: "SaaS early-stage, growth tracking, A/B testing léger, session replay, funnels.",
    bestForEn: "Early-stage SaaS, growth tracking, light A/B testing, session replay, funnels.",
    avoidIf: "Tu as une équipe data dédiée et des contraintes RGPD strictes côté DPO.",
  ...
  },
  {
    ...
    title: "Quelle alternative à Adobe Creative Cloud pour un créatif freelance ?",
    titleEn: "Which Adobe Creative Cloud alternative for a freelance creative?",
    subtitle: "Pour designer, illustrateur ou photographe qui paie 60€/mois Adobe CC mais n'utilise vraiment que 2 ou 3 logiciels.",
    ...
    monthlyBudget: 28,
    savings: 35,
    risk: "Payer la suite Adobe complète quand 90% du travail tient dans Figma + Canva + un éditeur photo.",
    riskEn: "Paying for full Adobe suite when 90% of work fits in Figma + Canva + a photo editor.",
    bestFor: "Branding, UX/UI, social, retouche photo light, supports marketing, illustration vectorielle.",
    bestForEn: "Branding, UX/UI, social, light photo retouching, marketing assets, vector illustration.",
    avoidIf: "Tu fais de la post-prod vidéo broadcast, du print pro complexe ou du motion design lourd.",
