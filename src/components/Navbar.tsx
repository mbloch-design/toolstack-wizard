    ...
    columns: [
      {
        ...
        links: [
          ...
          { fr: "Outils gratuits", en: "Free tools", path: "/tools" },
      ...
      },
      {
        ...
        links: [
          ...
          { fr: "Meilleurs rapports qualité-prix", en: "Best value for money", path: "/comparatifs" },
          { fr: "Faciles à prendre en main", en: "Easy to adopt", path: "/tools" },
          { fr: "Pour solo / freelance", en: "For solo / freelancers", path: "/stacks/freelance" },
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { fr: "CRM & ventes", en: "CRM & sales", path: "/category/crm" },
    ...
    columns: [
      {
        ...
        labelEn: "CREATIVES",
        links: [
          { fr: "Designer", en: "Designer", path: "/stacks/designer-freelance-solo" },
          { fr: "Directeur artistique", en: "Art director", path: "/stacks/designer-freelance-solo" },
          { fr: "Créateur de contenu", en: "Content creator", path: "/stacks/createur-contenu-operateur" },
      ...
      },
      {
        ...
        labelEn: "TECH",
        links: [
          { fr: "Développeur freelance", en: "Freelance developer", path: "/stacks/developpeur-freelance-shipper" },
          { fr: "No-code builder", en: "No-code builder", path: "/stacks/constructeur-app-nocode-ia" },
          { fr: "Product manager", en: "Product manager", path: "/stacks/ops-manager-fractional-coo" },
          { fr: "Growth", en: "Growth", path: "/stacks/ops-manager-fractional-coo" },
        ],
      },
      {
        labelFr: "BUSINESS",
        labelEn: "BUSINESS",
        links: [
          { fr: "Consultant", en: "Consultant", path: "/stacks/consultant-b2b-propre" },
          { fr: "Coach", en: "Coach", path: "/stacks/consultant-b2b-propre" },
          { fr: "Indépendant", en: "Independent", path: "/stacks/freelance" },
          { fr: "Ops / COO", en: "Ops / COO", path: "/stacks/ops-manager-fractional-coo" },
        ],
      },
      {
        labelFr: "SOLO",
  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        labelEn: "BY NEED",
        links: [
          { fr: "Lancer un projet", en: "Launch a project", path: "/stacks/solopreneur" },
          { fr: "Gérer ses clients", en: "Manage clients", path: "/stacks/consultant-b2b-propre" },
          { fr: "Créer du contenu", en: "Create content", path: "/stacks/createur-contenu-operateur" },
          { fr: "Automatiser", en: "Automate", path: "/stacks/constructeur-app-nocode-ia" },
          { fr: "Vendre", en: "Sell", path: "/stacks/solopreneur" },
        ],
      },
      {
        labelFr: "POPULAIRES",
    ...
    columns: [
      {
        ...
        links: [
          { fr: "Alternative à Notion", en: "Notion alternative", path: "/explorer/around/notion" },
          { fr: "Alternative à Framer", en: "Framer alternative", path: "/explorer/around/framer" },
          { fr: "Alternative à Webflow", en: "Webflow alternative", path: "/explorer/around/webflow" },
          { fr: "Alternative à Airtable", en: "Airtable alternative", path: "/explorer/around/airtable" },
          { fr: "Alternative à Zapier", en: "Zapier alternative", path: "/explorer/around/zapier" },
        ],
      },
      {
        labelFr: "BUDGET",
      ...
      },
      {
        ...
        labelEn: "BY USE CASE",
        links: [
          { fr: "Remplacer un CRM", en: "Replace a CRM", path: "/category/crm" },
          { fr: "Remplacer un outil design", en: "Replace a design tool", path: "/category/design-prototypage" },
          { fr: "Remplacer un outil projet", en: "Replace a project tool", path: "/category/gestion-projet" },
          { fr: "Remplacer un outil IA", en: "Replace an AI tool", path: "/category/ia-generaliste" },
        ],
      },
    ],
  },
