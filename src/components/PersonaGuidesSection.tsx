  ...
  fr: [
    {
      ...
      // Écran sombre avec syntaxe colorée — le vrai aesthetic dev, pas un MacBook sur fond blanc
      photo: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=900&q=85",
      wide: true,
    },
    {
      label: "Designer",
      ...
      // Mains en train de dessiner des wireframes sur papier — l'acte de créer, pas une belle mise en scène
      photo: "https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?auto=format&fit=crop&w=900&q=85",
      wide: false,
    },
    {
      label: "Consultant",
      ...
      // Discussion autour d'un tableau blanc, conversation réelle — pas un sourire figé en costume
    ...
    },
    {
      ...
      // Setup podcast/enregistrement — micro, lumière, le vrai métier du créateur
      photo: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=900&q=85",
      wide: false,
    },
    {
      label: "Ops / PMO",
      ...
      // Mur de post-its — le chaos visuel du pilotage de projet, vrai et vivant
      photo: "https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?auto=format&fit=crop&w=900&q=85",
      wide: true,
    },
  ],
  en: [
