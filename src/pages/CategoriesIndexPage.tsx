    ...
    <div className="min-h-screen">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col justify-between px-1 pb-1 pt-4">
                    ...
                    <span className={`mt-4 inline-flex items-center gap-2 text-sm font-semibold text-foreground transition-opacity ${isActive ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}>
                  ...
                  <div className="flex flex-1 flex-col justify-between px-1 pb-1 pt-5">
                    ...
                    <div className="mt-5 border-t border-border/70 pt-4">
                      <div className="flex items-center justify-between gap-3 text-xs font-semibold text-muted-foreground">
                        ...
                        <span>
                          {t("jusqu'à", "up to")} <span className="num-mono text-foreground">{stack.savings}€</span> {t("à revoir", "to review")}
                        </span>
                      </div>
      ...
      <section className="border-t border-border bg-card py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-6 md:flex-row md:items-center">
          ...
          <Link to={`${prefix}/selector`} className="inline-flex shrink-0 items-center gap-2 rounded-lg bg-foreground px-4 py-2.5 text-sm font-semibold text-background transition-opacity hover:opacity-90">
...
function CategoryCard({
  ...
  return (
    <Link
      ...
      className="group rounded-xl border border-border bg-card p-5 transition-colors duration-150 hover:border-foreground"
    >
      <div className="flex items-start gap-4">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-secondary text-foreground transition-colors duration-200 group-hover:bg-secondary">
          <Icon className="h-5 w-5" />
        </div>
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            <h3 className="text-sm font-medium tracking-tight text-foreground transition-colors duration-200 group-hover:text-foreground">
              {t(catName, englishName)}
            </h3>
            <ArrowRight className="mt-1 h-4 w-4 shrink-0 text-muted-foreground opacity-50 transition-all group-hover:translate-x-0.5 group-hover:text-foreground group-hover:opacity-100" />
          </div>
          {cat.description && (
