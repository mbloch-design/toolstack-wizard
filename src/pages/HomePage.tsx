      ...
      <section className="py-20">
        <div className="container">
          <div className="flex items-end justify-between">
            ...
            <Link to={`${prefix}/tools`} className="text-sm font-medium text-primary hover:underline">
              {t("Voir tout", "See all")} →
            </Link>
          </div>
      ...
      <section className="border-t border-border bg-secondary/20 py-20">
        <div className="container">
          <div className="flex items-end justify-between">
            ...
            <Link to={`${prefix}/guides`} className="text-sm font-medium text-primary hover:underline">
      ...
      <section className="py-20">
        <div className="container">
          <div className="mx-auto max-w-2xl rounded-2xl border border-primary/20 bg-accent/50 p-10 text-center">
            ...
            <Link
              to={`${prefix}/selector`}
              className="mt-6 inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:bg-primary/85"
            >
