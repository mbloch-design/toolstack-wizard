...
const LOCAL_REVIEW_SLUGS = new Set(['turbotic', 'kit', 'convertkit', 'activecampaign', 'adcreative-ai', 'aircall', 'amplemarket', 'apollo-io', 'brand24', 'brevo', 'buddy-punch', 'callrail', 'clickup', 'deel', 'descript', 'dext', 'gamma', 'getresponse', 'ignition', 'krispcall', 'leadpages']);
