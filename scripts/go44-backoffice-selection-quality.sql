-- GO44 targeted preprod SQL.
-- Purpose: expose selected tools in the back-office sessions view so the
-- quality tab can detect incomplete or uncertain tool selections.
...
COMMENT ON VIEW public.vw_backoffice_diagnostic_sessions IS
  'Back-office diagnostic session rollup, including selected tools for GO44 selection quality checks.';
