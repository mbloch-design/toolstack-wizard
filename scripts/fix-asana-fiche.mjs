...
a.idealForFr = "Idéal pour petites équipes projet, studios et agences qui ont plusieurs projets clients en parallèle. Surdimensionné pour un solo qui gère surtout ses propres tâches.";
a.idealForEn = "Best for small project teams, studios and agencies juggling several client projects in parallel. Overkill for a solo operator mostly managing their own tasks.";
